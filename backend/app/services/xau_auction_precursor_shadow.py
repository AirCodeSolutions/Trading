...
STRATEGY_ID = "XAUUSD:precursor_auction_failure_shadow"
STATE_FILE = "XAUUSD_precursor_auction_shadow_state.json"
LEDGER_FILE = "XAUUSD_precursor_auction_shadow.jsonl"
HORIZON_BARS = 12
STOP_ATR_MULTIPLE = 1.5
TARGET_R = 1.0


def advance_xau_auction_precursor_shadow_once(
    files_dir: Path,
    runtime_dir: Path,
    ...
    if state is None:
        ...
        return load_xau_auction_precursor_shadow_summary(runtime_dir)
    ...
    for observation in observations:
        ...
        candidate = OpportunityCandidate(
            ...
            reason="prospective XAU auction-failure-reclaim precursor shadow",
        )
...
def load_xau_auction_precursor_shadow_summary(
    runtime_dir: Path,
) -> PrecursorExecutionShadowSummary:
